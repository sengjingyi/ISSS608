...
#### Jing Yi's attempts: Shade and Pie
...
1.  *tl.pos* - To set the position of text labels to "Left Top"
2.  *tl.cex -* To adjust the size of the variable names text and align with size of color legend
3.  *tl.offset* - To offset the text labels
4.  *cl.pos* - To adjust the position of the color text to the "Right"
5.  *cl.cex* - To adjust the size of the color legend text and align with size of variable names text
6.  *cl.offset -* To offset for the color legend text for better alignment.
