...
var <- NGA_wp["pct_functional"] %>% st_set_geometry(NULL) 
...
```{r, include = FALSE}
#| echo: false
percentmap <- source("percentmap_fx.R", local = knitr::knit_global())$value
```
...
```{r, include = FALSE}
#| echo: false
boxbreaks <- source("boxbreak_fx.R", local = knitr::knit_global())$value
...
```{r, include = FALSE}
#| echo: false
get.var <- source("getvar_fx.R", local = knitr::knit_global())$value
```
...
```{r, include = FALSE}
#| echo: false
boxmap <- source("boxmap_fx.R", local = knitr::knit_global())$value
```
