...
route_w_catch <- route_w_catch %>%
 ...
 m3 <- tx_qty1 %>% 
  left_join(route_w_catch, by = c("dest" = "final_area", "tx_date" = "route_end")) %>%   filter(grepl(fish_species, probable_fish_species))

#some cargo dropped - fish species not within list (only 2627 returned, out of 5307)
# analyse missing cargo 
